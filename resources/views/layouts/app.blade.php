            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
                            <a class="nav-link" href="{{ route('voire.verssements') }}">Les verssements</a>
                        </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}">{{ __('s\'indentifier') }}</a>
                            </li>
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('voire.pourcentages') }}">Les pourcentages</a>
                                <a class="dropdown-item" href="{{ route('voire.familles') }}">Les familles</a>
                                <a class="dropdown-item" href="{{ route('voire.fournisseurs') }}">Les fournisseurs</a>
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->nom_complet }} <span class="caret"></span>
                                </a>
